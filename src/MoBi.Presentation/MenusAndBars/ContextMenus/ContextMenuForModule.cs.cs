...
namespace MoBi.Presentation.MenusAndBars.ContextMenus
{
   internal class ContextMenuForModule : ContextMenuBase, IContextMenuFor<Module>
   {
      ...
      public IContextMenu InitializeWith(ObjectBaseDTO dto, IPresenter presenter)
      {
         ...
         var item = CreateMenuButton.WithCaption(AppConstants.MenuNames.LoadBuildingBlock)
            .WithCommandFor<LoadBuildingBlockToModuleUICommand, Module>(module, _container)
